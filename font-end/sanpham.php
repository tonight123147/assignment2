            ...
            <div class="row top-hai-content">
                ...
                <div class="col-9 top-haidrop-item ">
                    <ul>
                        ...
                        <li><a style="color: rgba(243, 199, 3, 0.924);" href="./sanpham.php">Sản Phẩm</a></li>
    ...
    <section>
        <div class="container-fluid">
            ...
            <div class="row product2">
                ...
                <?php  //này đống mở ghi cái html vào ở giữa bởi vì cái <li></li> html nên nó sẽ ko hiện những sẽ ko như html đc
                }
                echo "</ul>";
                ?>
            </div>
            <div class="now product3">
                <?php
                $sql = "SELECT * FROM product WHERE isShow = 'checked'";
                $query =  $conn->query($sql);
                while ($row = mysqli_fetch_assoc($query)) { //mysqli_fetch là phân tách opject thành mãng
                ?>
                    <div class="col-12 col-sm-6 col-md-4 p-2">
                        <div class="img-center">
                            ...
                            <div class="caption">
                                ...
                                <button class=" btn btn-costs"><a href="Detail-sanpham.php?view=detail&proID=<?php echo $row["proID"]; ?>">Chi Tiết</a></button>
                                <button class=" btn Buy"><a href="cart.php?view=cart&proID=<?php echo $row["proID"] ?>">Mua ngay</a></button>
                            </div>
                        </div>
                    </div>
                <?php
